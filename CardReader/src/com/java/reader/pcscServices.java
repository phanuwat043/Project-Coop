...
import com.java.api.ByteUtils;
import com.java.api.CID;
import com.java.api.LaserNumber;
import com.java.api.SmartCardServices;
import com.java.convert.Converter;
import com.java.convert.ConverterFactory;
import com.java.convert.Spec;
import com.java.convert.SpecPropertyReader;
import com.java.model.MoiApplet1Info;
import com.java.model.Name;
import com.java.model.NhsoAppletInfo;
import com.java.model.OldMoiApplet1Info;
        ...
        for (Spec spec : specs) {
            if ((readPicture)
                ...
                try {
                    ...
                    System.out.println(converter.toObject(allocate.array()));
                    allocate = null;
                } catch (Exception ex) {
